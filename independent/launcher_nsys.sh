...
do
    ...
    log_file_name="profile/${output_file_name:1}.qdrep"
    output_file_name="logs/${output_file_name:1}.nsys.log"
    echo "Saving output to: $output_file_name"
    nsys profile -o $log_file_name --force-overwrite true python $script_name $args | tee ${output_file_name}
done < $argsfile_name
